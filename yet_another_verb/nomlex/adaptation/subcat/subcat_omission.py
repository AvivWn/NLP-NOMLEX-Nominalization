from yet_another_verb.nomlex.constants import LexiconType, NomTypeProperty, EntryProperty
from yet_another_verb.nomlex.constants.subcat_type import SUBCAT_TYPES
