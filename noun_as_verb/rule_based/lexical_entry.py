...
from noun_as_verb.rule_based import LexicalSubcat
...
class Entry:
	...
	def match_arguments(self, argument_candidates: list, predicate: ExtractedArgument, suitable_verb: str, arguments_predictor=None):
		...
		:return: A list of all the possible argument extractions for this entry ([ARG_ROOT_URELATIONS])
		"""
		...
		for subcat_type in self.subcats.keys():
			extractions += self.subcats[subcat_type].match_arguments(argument_candidates, predicate, suitable_verb, arguments_predictor)
