...
lexicon_fixes_dict = {
	...
	"NOM-NP-ING": 				(([COMP_NP, COMP_ING_NPC],					{COMP_ING_NPC: [POS_ING]}, 												{COMP_OBJ: COMP_NP},								{}),
								 ([COMP_NP, COMP_ING_NPC],					{COMP_ING_NPC: [POS_ING]},												{COMP_OBJ: COMP_NP},								{})),
	"NOM-NP-ING-OC": 			(([COMP_OBJ, COMP_ING_OC], 					{COMP_ING_OC: [POS_ING]},												{},													{}),
								 ([COMP_OBJ, COMP_ING_OC],					{COMP_ING_OC: [POS_ING]},												{},													{})),
	"NOM-NP-ING-SC": 			(([COMP_OBJ, COMP_ING_SC], 					{COMP_ING_SC: [POS_ING]}, 												{},													{}),
								 ([COMP_OBJ, COMP_ING_SC],					{COMP_ING_SC: [POS_ING]},												{},													{})),
	...
	"NOM-P-NP-ING": 			(([COMP_PP, COMP_ING_POC],					{COMP_ING_POC: [POS_ING]},												{},													{}),
								 ([COMP_PP, COMP_ING_POC], 					{COMP_ING_POC: [POS_ING]},	 											{},													{})),
	"NOM-NP-P-NP-ING": 			(([COMP_OBJ, COMP_PP, COMP_ING_POC],		{COMP_ING_POC: [POS_ING]},												{},													{}),
								 ([COMP_OBJ, COMP_PP, COMP_ING_POC],		{COMP_ING_POC: [POS_ING]},												{},													{})),
...
nom_types_to_args_dict = {
	...
	NOM_TYPE_IND_OBJ: [COMP_IND_OBJ, COMP_PP1, COMP_PP2, COMP_PP], # Sometimes the indirect object actually refer to a preposition with "to\for"
