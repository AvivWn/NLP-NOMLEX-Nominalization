...
complex_argument_positions = {
	...
	"NOM-ING-SC":				({COMP_ING_SC: [POS_ING], COMP_POSS_ING_SC: [{COMP_ING_SC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_ING_SC: [POS_ING]}),
	"NOM-POSSING":				({COMP_ING_POSSC: [POS_ING], COMP_POSS_ING_VC: [{COMP_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_ING_POSSC: [POS_ING], COMP_POSS_ING_VC: [{COMP_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]}),
	"NOM-P-ING-SC":				({COMP_POSS_ING_SC: [{COMP_P_ING_SC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {}),
	"NOM-P-POSSING":			({COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]}),
	"NOM-PP-P-POSSING":			({COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]}),
	"NOM-POSSING-PP":			({COMP_ING_POSSC: [POS_ING], COMP_POSS_ING_VC: [{COMP_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_ING_POSSC: [POS_ING], COMP_POSS_ING_VC: [{COMP_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]}),
	"NOM-NP-P-POSSING": 		({COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]},
								 {COMP_POSS_ING_VC: [{COMP_P_ING_POSSC: [POS_NSUBJ, POS_DET_POSS]}]})
}
...
argument_constraints = {
	...
	"NOM-PP-TO-INF-RECIP":		({COMP_SUBJ: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_INCLUDING: COMP_P_IND_OBJ, ARG_CONSTRAINTS: [ARG_CONSTRAINT_PLURAL]}},
								 {COMP_SUBJ: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_INCLUDING: COMP_P_IND_OBJ, ARG_CONSTRAINTS: [ARG_CONSTRAINT_PLURAL]}}),
	...
	"NOM-ADVP-PP":				({COMP_ADVP: {ARG_ROOT_UPOSTAGS: [UPOS_ADV]}},
								 {COMP_ADVP: {ARG_ROOT_UPOSTAGS: [UPOS_ADV]}, COMP_ADJP: {ARG_ROOT_UPOSTAGS: [UPOS_ADJ]}}),
	"NOM-NP-AS-ADJP":			({COMP_ADJP: {ARG_ROOT_UPOSTAGS: [UPOS_ADJ]}},
								 {COMP_ADJP: {ARG_ROOT_UPOSTAGS: [UPOS_ADJ]}}),
	...
	"NOM-ING-SC":				({COMP_ING_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_SUBJ]}, 						COMP_POSS_ING_SC: {ARG_CONTROLLED: [COMP_SUBJ], ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_ING_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-POSSING": 				({COMP_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 				COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]},				COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}}),
	"NOM-P-ING-SC": 			({COMP_P_ING_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_SUBJ]}, 						COMP_POSS_ING_SC: {ARG_CONTROLLED: [COMP_SUBJ], ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_P_ING_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-P-POSSING": 			({COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}}),
	"NOM-PP-P-POSSING": 		({COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}}),
	"NOM-P-NP-ING": 			({COMP_P_NP_ING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING]}},
								 {COMP_P_NP_ING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING]}}),
	"NOM-POSSING-PP": 			({COMP_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 				COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 				COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}}),
	"NOM-NP-P-POSSING": 		({COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}},
								 {COMP_P_ING_POSSC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_POSS_ING_VC]}, 			COMP_POSS_ING_VC: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_POSSESSIVE]}}),
	"NOM-NP-P-NP-ING": 			({COMP_P_NP_ING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING]}},
								 {COMP_P_NP_ING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING]}}),

	# INF
	"NOM-FOR-TO-INF": 			({COMP_TO_INF_FOR_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP], ARG_CONTIGUOUS_TO: COMP_FOR_NP}},
								 {COMP_TO_INF_FOR_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP], ARG_CONTIGUOUS_TO: COMP_FOR_NP}}),
	"NOM-NP-TO-INF-OC": 		({COMP_TO_INF_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_OBJ]}},
								 {COMP_TO_INF_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_OBJ]}}),
	"NOM-NP-TO-INF-SC": 		({COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-NP-TO-INF-VC": 		({COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ], ARG_CONTIGUOUS_TO: COMP_OBJ}}), # ONLY FOR NOM
	"NOM-TO-INF-SC":			({COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-P-NP-TO-INF-OC":		({COMP_TO_INF_P_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP]}},
								 {COMP_TO_INF_P_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP]}}),
	"NOM-P-NP-TO-INF":			({COMP_TO_INF_P_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP], ARG_CONTIGUOUS_TO: COMP_PP}},
								 {COMP_TO_INF_P_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP], ARG_CONTIGUOUS_TO: COMP_PP}}),
	"NOM-P-NP-TO-INF-VC":		({COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_PP], ARG_CONTIGUOUS_TO: [COMP_PP]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_PP], ARG_CONTIGUOUS_TO: [COMP_PP]}}),
	"NOM-PP-FOR-TO-INF":		({COMP_TO_INF_FOR_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP]}},
								 {COMP_TO_INF_FOR_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP]}}),
	"NOM-PP-HOW-TO-INF":		({COMP_HOW_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB]}},
								 {COMP_HOW_TO_INF: {ARG_ROOT_UPOSTAGS: [UPOS_VERB]}}), # The complement can be tensed on untensed

	"NOM-S":					({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-THAT-S":				({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-S":					({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S":			({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	...
	# SUBJUNCT
	"NOM-S-SUBJUNCT":			({COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S-SUBJUNCT":	({COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-AS-IF-S-SUBJUNCT":	({COMP_AS_IF_S: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}},
								 {COMP_AS_IF_S: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}})
}
