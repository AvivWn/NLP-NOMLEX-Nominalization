...
lexicon_fixes_dict = {
	...
	"NOM-P-NP-ING": 			(([COMP_P_NP, COMP_ING_POC],				{},																		{COMP_PP: COMP_P_NP},								{}),
								 ([COMP_P_NP, COMP_ING_POC], 				{},	 																	{COMP_PP: COMP_P_NP},								{})),
	"NOM-NP-P-NP-ING": 			(([COMP_OBJ, COMP_P_NP, COMP_ING_POC],		{},																		{COMP_PP: COMP_P_NP},								{}),
								 ([COMP_OBJ, COMP_P_NP, COMP_ING_POC],		{},																		{COMP_PP: COMP_P_NP},								{})),
	...
	"NOM-P-NP-TO-INF-OC":		(([COMP_P_NP, COMP_TO_INF_POC], 			{COMP_TO_INF_POC: [POS_TO_INF]}, 										{COMP_PP: COMP_P_NP},								{}),
								 ([COMP_P_NP, COMP_TO_INF_POC],				{COMP_TO_INF_POC: [POS_TO_INF]},										{COMP_PP: COMP_P_NP},								{})),
	"NOM-P-NP-TO-INF":			(([COMP_P_NP, COMP_TO_INF_POC], 			{COMP_TO_INF_POC: [POS_TO_INF]}, 										{COMP_PP: COMP_P_NP},								{}),
								 ([COMP_P_NP, COMP_TO_INF_POC],				{COMP_TO_INF_POC: [POS_TO_INF]},										{COMP_PP: COMP_P_NP},								{})), # why is it different from NOM-P-NP-TO-INF-OC ?????
	"NOM-P-NP-TO-INF-VC":		(([COMP_P_NP, COMP_TO_INF_VC], 				{COMP_TO_INF_VC: [POS_TO_INF]}, 										{COMP_PP: COMP_P_NP},								{}),
								 ([COMP_P_NP, COMP_TO_INF_VC],				{COMP_TO_INF_VC: [POS_TO_INF]},											{COMP_PP: COMP_P_NP},								{})),
	...
	"NOM-PP-TO-INF-RECIP":		(([COMP_TO_INF_SC],	 						{COMP_SECOND_SUBJ: ["with", OPT_POS], COMP_TO_INF_SC: [POS_TO_INF]},	{COMP_PP1: COMP_SECOND_SUBJ},						{}),
								 ([COMP_TO_INF_SC, COMP_SECOND_SUBJ], 		{COMP_SECOND_SUBJ: ["with"], COMP_TO_INF_SC: [POS_TO_INF]},				{COMP_PP1: COMP_SECOND_SUBJ},						{})), # SUBJECT = SUBJECT and PVAL NP
...
complex_argument_positions = {
	...
	"NOM-NP-ING-SC":			({COMP_ING_SC: [POS_ING]},
								 {COMP_ING_SC: [POS_ING]}),
	"NOM-P-NP-ING":				({COMP_ING_POC: [POS_ING, {COMP_P_NP: [POS_ACL]}], 			COMP_P_NP: [ADD_POS, {COMP_ING_POC: [POS_NSUBJ]}]},
								 {COMP_ING_POC: [POS_ING, {COMP_P_NP: [POS_ACL]}], 			COMP_P_NP: [ADD_POS, {COMP_ING_POC: [POS_NSUBJ]}]}),
	"NOM-NP-P-NP-ING":			({COMP_ING_POC: [POS_ING, {COMP_P_NP: [POS_ACL]}], 			COMP_P_NP: [ADD_POS, {COMP_ING_POC: [POS_NSUBJ]}]},
								 {COMP_ING_POC: [POS_ING, {COMP_P_NP: [POS_ACL]}], 			COMP_P_NP: [ADD_POS, {COMP_ING_POC: [POS_NSUBJ]}]}),
}
...
argument_constraints = {
	...
	"NOM-PP-TO-INF-RECIP":		({COMP_SUBJ: {ARG_INCLUDING: COMP_SECOND_SUBJ, ARG_CONSTRAINTS: [ARG_CONSTRAINT_PLURAL]}, 			COMP_TO_INF_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_RELATIONS: [URELATION_TO], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_SUBJ: {ARG_INCLUDING: COMP_SECOND_SUBJ, ARG_CONSTRAINTS: [ARG_CONSTRAINT_PLURAL]}, 			COMP_TO_INF_SC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_RELATIONS: [URELATION_TO], ARG_CONTROLLED: [COMP_SUBJ]}}),
	...
	"NOM-PP-P-POSSING": 		({COMP_P_POSSING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONSTRAINTS: [ARG_CONSTRAINT_OPTIONAL_POSSESSIVE]}},
								 {COMP_P_POSSING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONSTRAINTS: [ARG_CONSTRAINT_OPTIONAL_POSSESSIVE]}}),
	"NOM-P-NP-ING": 			({COMP_ING_POC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_P_NP]},						COMP_P_NP: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}},
								 {COMP_ING_POC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_P_NP]},						COMP_P_NP: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}}),
	...
	"NOM-NP-P-POSSING": 		({COMP_P_POSSING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONSTRAINTS: [ARG_CONSTRAINT_OPTIONAL_POSSESSIVE]}},
								 {COMP_P_POSSING: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONSTRAINTS: [ARG_CONSTRAINT_OPTIONAL_POSSESSIVE]}}),
	"NOM-NP-P-NP-ING": 			({COMP_ING_POC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_P_NP]},						COMP_P_NP: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}},
								 {COMP_ING_POC: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_ROOT_PATTERNS: [PATTERN_ING], ARG_CONTROLLED: [COMP_P_NP]},						COMP_P_NP: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}}),

	# INF
	"NOM-FOR-TO-INF": 			({COMP_FOR_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO, URELATION_NSUBJ], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}},
								 {COMP_FOR_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO, URELATION_NSUBJ], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}}),
	"NOM-NP-TO-INF-OC": 		({COMP_TO_INF_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_OBJ]}},
								 {COMP_TO_INF_OC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_OBJ]}}),
	"NOM-NP-TO-INF-SC": 		({COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-NP-TO-INF-VC": 		({COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ], ARG_CONTIGUOUS_TO: COMP_OBJ}}), # ONLY FOR NOM
	"NOM-TO-INF-SC":			({COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-P-NP-TO-INF-OC":		({COMP_TO_INF_POC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_P_NP]}},
								 {COMP_TO_INF_POC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_P_NP]}}),
	"NOM-P-NP-TO-INF":			({COMP_TO_INF_POC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_P_NP], ARG_CONTIGUOUS_TO: COMP_P_NP}},
								 {COMP_TO_INF_POC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_P_NP], ARG_CONTIGUOUS_TO: COMP_P_NP}}),
	"NOM-P-NP-TO-INF-VC":		({COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ, COMP_P_NP], ARG_CONTIGUOUS_TO: [COMP_P_NP]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONTROLLED: [COMP_SUBJ, COMP_P_NP], ARG_CONTIGUOUS_TO: [COMP_P_NP]}}),
	"NOM-PP-FOR-TO-INF":		({COMP_FOR_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO, URELATION_NSUBJ], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}},
								 {COMP_FOR_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO, URELATION_NSUBJ], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX], ARG_CONSTRAINTS: [ARG_CONSTRAINT_REQUIRED_PREFIX]}}),
	"NOM-PP-HOW-TO-INF":		({COMP_HOW_TO_INF: {ARG_ROOT_RELATIONS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX]}},
								 {COMP_HOW_TO_INF: {ARG_ROOT_UPOSTAGS: [UPOS_VERB, UPOS_AUX]}}), # The complement can be tensed on untensed

	# SBAR
	"NOM-S":					({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ], ARG_ILLEGAL_PREFIXES: WHERE_WHEN_OPTIONS + HOW_OPTIONS + WH_VERB_OPTIONS}}, # The "that" complementizer word isn't required for verbs
	...
	"NOM-THAT-S":				({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-S":					({COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ], ARG_ILLEGAL_PREFIXES: WHERE_WHEN_OPTIONS + HOW_OPTIONS + WH_VERB_OPTIONS}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	...
	# SUBJUNCT
	"NOM-S-SUBJUNCT":			({COMP_SBAR_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S-SUBJUNCT":	({COMP_SBAR_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-AS-IF-S-SUBJUNCT":	({COMP_AS_IF_S_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}},
								 {COMP_AS_IF_S_SUBJUNCT: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_RELATIONS: [URELATION_NSUBJ]}})
}
