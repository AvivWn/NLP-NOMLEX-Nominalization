...
argument_constraints = {
	...
	# INF
	"NOM-FOR-TO-INF": 			({COMP_TO_INF_FOR_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP], ARG_CONTIGUOUS_TO: COMP_FOR_NP}},
								 {COMP_TO_INF_FOR_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP], ARG_CONTIGUOUS_TO: COMP_FOR_NP}}),
	"NOM-NP-TO-INF-OC": 		({COMP_TO_INF_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_OBJ]}},
								 {COMP_TO_INF_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_OBJ]}}),
	"NOM-NP-TO-INF-SC": 		({COMP_TO_INF_SC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-NP-TO-INF-VC": 		({COMP_TO_INF_VC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_OBJ], ARG_CONTIGUOUS_TO: COMP_OBJ}}), # ONLY FOR NOM
	"NOM-TO-INF-SC":			({COMP_TO_INF_SC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}},
								 {COMP_TO_INF_SC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ]}}),
	"NOM-P-NP-TO-INF-OC":		({COMP_TO_INF_P_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP]}},
								 {COMP_TO_INF_P_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP]}}),
	"NOM-P-NP-TO-INF":			({COMP_TO_INF_P_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP], ARG_CONTIGUOUS_TO: COMP_PP}},
								 {COMP_TO_INF_P_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_PP], ARG_CONTIGUOUS_TO: COMP_PP}}),
	"NOM-P-NP-TO-INF-VC":		({COMP_TO_INF_VC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_PP], ARG_CONTIGUOUS_TO: [COMP_PP]}},
								 {COMP_TO_INF_VC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_SUBJ, COMP_PP], ARG_CONTIGUOUS_TO: [COMP_PP]}}),
	"NOM-PP-FOR-TO-INF":		({COMP_TO_INF_FOR_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP]}},
								 {COMP_TO_INF_FOR_OC: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_CONTROLLED: [COMP_FOR_NP]}}),
	"NOM-PP-HOW-TO-INF":		({COMP_HOW_TO_INF: {ARG_ROOT_PATTERNS: [URELATION_TO], ARG_ROOT_UPOSTAGS: [UPOS_VERB]}},
								 {COMP_HOW_TO_INF: {ARG_ROOT_UPOSTAGS: [UPOS_VERB]}}), # The complement can be tensed on untensed

	"NOM-S":					({COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-THAT-S":				({COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-S":					({COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S":			({COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	...
	# SUBJUNCT
	"NOM-S-SUBJUNCT":			({COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S-SUBJUNCT":	({COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-AS-IF-S-SUBJUNCT":	({COMP_AS_IF_S: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}},
								 {COMP_AS_IF_S: {ARG_CONSTRAINTS: [ARG_CONSTRAINT_SUBJUNCT], ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}})
}
