...
argument_constraints = {
	...
	"NOM-PP-TO-INF-RECIP":		({COMP_SUBJ: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_INCLUDING: COMP_P_IND_OBJ, ARG_PLURAL: True}},
								 {COMP_SUBJ: {ARG_ROOT_UPOSTAGS: [UPOS_VERB], ARG_INCLUDING: COMP_P_IND_OBJ, ARG_PLURAL: True}}),
	...
	# SUBJUNCT
	"NOM-S-SUBJUNCT":			({COMP_SBAR: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}}, # The "that" complementizer word isn't required for verbs
								 {COMP_SBAR: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-PP-THAT-S-SUBJUNCT":	({COMP_SBAR: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}},
								 {COMP_SBAR: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ, URELATION_THAT]}}),
	"NOM-NP-AS-IF-S-SUBJUNCT":	({COMP_AS_IF_S: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}},
								 {COMP_AS_IF_S: {ARG_SUBJUNCT: True, ARG_ROOT_PATTERNS: [URELATION_NSUBJ]}})
}
